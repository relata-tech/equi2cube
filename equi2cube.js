    ...
    for (var face = 0; face < 6; ++face) {
      ...
      for (var j = 0; j < faceHeight; ++j) {
        for (var i = 0; i < faceWidth; ++i) {
          ...
          var rA = srgbToLinear(inData[pA + 0] | 0),
            gA = srgbToLinear(inData[pA + 1] | 0),
            bA = srgbToLinear(inData[pA + 2] | 0),
            aA = (inData[pA + 3] | 0) * (1.0 / 255.0);
          var rB = srgbToLinear(inData[pB + 0] | 0),
            gB = srgbToLinear(inData[pB + 1] | 0),
            bB = srgbToLinear(inData[pB + 2] | 0),
            aB = (inData[pB + 3] | 0) * (1.0 / 255.0);
          var rC = srgbToLinear(inData[pC + 0] | 0),
            gC = srgbToLinear(inData[pC + 1] | 0),
            bC = srgbToLinear(inData[pC + 2] | 0),
            aC = (inData[pC + 3] | 0) * (1.0 / 255.0);
          var rD = srgbToLinear(inData[pD + 0] | 0),
            gD = srgbToLinear(inData[pD + 1] | 0),
            bD = srgbToLinear(inData[pD + 2] | 0),
            aD = (inData[pD + 3] | 0) * (1.0 / 255.0);
